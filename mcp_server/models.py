...
class CertificateParameters(BaseModel):
    coursename: str = Field(
        ...
        examples=[
            'DEDH P,GI S,GI W,MESC,LCOM EW,LCOM Tac,CHME Q,AA/APP,SSR/NAM,Direct Entry El,ITSC S'
        ],
    )
    personalno: str = Field(..., description='Personal No', examples=['12345-T'])
    unit: str = Field(
        ...,
        description='Unit Name',
        examples=['Valsura,Shivaji,Dronacharya,SignalSchool,NIAT'],
    )
